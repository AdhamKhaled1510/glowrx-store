...
async function initDb() {
  ...
  await query('CREATE TABLE IF NOT EXISTS orders (id INTEGER PRIMARY KEY AUTOINCREMENT, user_id INTEGER REFERENCES users(id), items TEXT NOT NULL, total REAL NOT NULL, status TEXT DEFAULT \'pending\', payment_method TEXT NOT NULL, payment_status TEXT DEFAULT \'pending\', shipping_address TEXT, phone TEXT, notes TEXT, internal_notes TEXT, created_at DATETIME DEFAULT CURRENT_TIMESTAMP)');
